...
def main() -> None:
    ...
    if station_aabb:
        ...
        # spawn on the Wilson driveway, 3/4 on the stone hall (rails on the bank behind)
        sx = hall_ox + px * (hall_half_w + 16.0) + ux * 16.0
        sz = hall_oz + pz * (hall_half_w + 16.0) + uz * 16.0
